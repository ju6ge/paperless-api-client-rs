...
impl CustomFields {
    ...
    ) -> Result<crate::types::PaginatedCustomFieldList, crate::types::error::Error> {
        let mut req = self.client.client.request(
            http::Method::GET,
            format!("{}/{}", self.client.base_url, "api/custom_fields/"),
        );
            ...
            let next_pages = futures::stream::try_unfold(
                ...
                move |(prev_page_token, new_result)| async move {
                        ...
                        && prev_page_token != new_result.next_page_token()
                    {
                        ...
                        .map_ok(|result: crate::types::PaginatedCustomFieldList| {
                            Some((
    ...
    pub async fn retrieve<'a>(
        ...
        let mut req = self.client.client.request(
            ...
            format!(
                ...
                "api/custom_fields/{id}/".replace("{id}", &format!("{id}"))
            ),
        );
        req = req.header("Authorization", format!("Token {}", &self.client.token));
        let resp = req.send().await?;
    ...
    #[doc = "Perform a `PATCH` request to `/api/custom_fields/{id}/`.\n\nMixin to add document count to queryset, permissions-aware if needed\n\n**Parameters:**\n\n- `id: i64`: A unique integer value identifying this custom field. (required)\n\n```rust,no_run\nasync fn example_custom_fields_partial_update() -> anyhow::Result<()> {\n    let client = paperless_api_client::Client::new_from_env();\n    let result: paperless_api_client::types::CustomField = client\n        .custom_fields()\n        .partial_update(\n            4 as i64,\n            &paperless_api_client::types::PatchedCustomFieldRequest {\n                name: Some(\"some-string\".to_string()),\n                data_type: Some(paperless_api_client::types::DataTypeEnum::Monetary),\n                extra_data: Some(serde_json::Value::String(\"some-string\".to_string())),\n            },\n        )\n        .await?;\n    println!(\"{:?}\", result);\n    Ok(())\n}\n```"]
    #[tracing::instrument]
    #[allow(non_snake_case)]
    pub async fn partial_update<'a>(
        &'a self,
        id: i64,
        body: &crate::types::PatchedCustomFieldRequest,
    ) -> Result<crate::types::CustomField, crate::types::error::Error> {
        let mut req = self.client.client.request(
            http::Method::PATCH,
            format!(
