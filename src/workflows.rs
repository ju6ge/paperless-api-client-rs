...
impl Workflows {
    ...
    #[doc = "Perform a `GET` request to `/api/workflows/`.\n\n**Parameters:**\n\n- `page: Option<i64>`: A page number within the paginated result set.\n- `page_size: Option<i64>`: Number of results to return per page.\n\n```rust,no_run\nuse futures_util::TryStreamExt;\nasync fn example_workflows_list_stream() -> anyhow::Result<()> {\n    let client = paperless_api_client::Client::new_from_env();\n    let mut workflows = client.workflows();\n    let mut stream = workflows.list_stream(Some(4 as i64));\n    loop {\n        match stream.try_next().await {\n            Ok(Some(item)) => {\n                println!(\"{:?}\", item);\n            }\n            Ok(None) => {\n                break;\n            }\n            Err(err) => {\n                return Err(err.into());\n            }\n        }\n    }\n\n    Ok(())\n}\n```"]
    #[tracing::instrument]
    ...
    ) -> Result<crate::types::PaginatedWorkflowList, crate::types::error::Error> {
        let mut req = self.client.client.request(
            http::Method::GET,
            format!("{}/{}", self.client.base_url, "api/workflows/"),
        );
    ...
    pub fn list_stream<'a>(
        &'a self,
        page_size: Option<i64>,
    ) -> impl futures::Stream<Item = Result<crate::types::Workflow, crate::types::error::Error>>
           + Unpin
           + '_ {
                ...
                let next_pages = futures::stream::try_unfold(
                    ...
                    move |(prev_page_token, new_result)| async move {
                            ...
                            && prev_page_token != new_result.next_page_token()
                        {
                            ...
                            .map_ok(|result: crate::types::PaginatedWorkflowList| {
                                Some((
    ...
    #[doc = "Perform a `GET` request to `/api/workflows/{id}/`.\n\n**Parameters:**\n\n- `id: i64`: A unique integer value identifying this workflow. (required)\n\n```rust,no_run\nasync fn example_workflows_retrieve() -> anyhow::Result<()> {\n    let client = paperless_api_client::Client::new_from_env();\n    let result: paperless_api_client::types::Workflow = client.workflows().retrieve(4 as i64).await?;\n    println!(\"{:?}\", result);\n    Ok(())\n}\n```"]
    #[tracing::instrument]
    #[allow(non_snake_case)]
    pub async fn retrieve<'a>(
        ...
        let mut req = self.client.client.request(
            ...
            format!(
                ...
                "api/workflows/{id}/".replace("{id}", &format!("{id}"))
            ),
        );
        req = req.header("Authorization", format!("Token {}", &self.client.token));
        let resp = req.send().await?;
    ...
    #[doc = "Perform a `PUT` request to `/api/workflows/{id}/`.\n\n**Parameters:**\n\n- `id: i64`: A unique integer value identifying this workflow. (required)\n\n```rust,no_run\nasync fn example_workflows_update() -> anyhow::Result<()> {\n    let client = paperless_api_client::Client::new_from_env();\n    let result: paperless_api_client::types::Workflow = client\n        .workflows()\n        .update(\n            4 as i64,\n            &paperless_api_client::types::WorkflowRequest {\n                name: \"some-string\".to_string(),\n                order: Some(4 as i64),\n                enabled: Some(true),\n                triggers: vec![paperless_api_client::types::WorkflowTriggerRequest {\n                    id: Some(4 as i64),\n                    sources: vec![paperless_api_client::types::SourcesEnum::MailFetch],\n                    type_: paperless_api_client::types::WorkflowTriggerTypeEnum::DocumentUpdated,\n                    filter_path: Some(\"some-string\".to_string()),\n                    filter_filename: Some(\"some-string\".to_string()),\n                    filter_mailrule: Some(4 as i64),\n                    matching_algorithm: Some(\n                        paperless_api_client::types::WorkflowTriggerMatchingAlgorithmEnum::ExactMatch,\n                    ),\n                    match_: Some(\"some-string\".to_string()),\n                    is_insensitive: Some(true),\n                    filter_has_tags: Some(vec![4 as i64]),\n                    filter_has_all_tags: Some(vec![4 as i64]),\n                    filter_has_not_tags: Some(vec![4 as i64]),\n                    filter_custom_field_query: Some(\"some-string\".to_string()),\n                    filter_has_not_correspondents: Some(vec![4 as i64]),\n                    filter_has_not_document_types: Some(vec![4 as i64]),\n                    filter_has_not_storage_paths: Some(vec![4 as i64]),\n                    filter_has_correspondent: Some(4 as i64),\n                    filter_has_document_type: Some(4 as i64),\n                    filter_has_storage_path: Some(4 as i64),\n                    schedule_offset_days: Some(4 as i64),\n                    schedule_is_recurring: Some(true),\n                    schedule_recurring_interval_days: Some(4 as i64),\n                    schedule_date_field: Some(paperless_api_client::types::ScheduleDateFieldEnum::Modified),\n                    schedule_date_custom_field: Some(4 as i64),\n                }],\n                actions: vec![paperless_api_client::types::WorkflowActionRequest {\n                    id: Some(4 as i64),\n                    type_: Some(paperless_api_client::types::WorkflowActionTypeEnum::Email),\n                    assign_title: Some(\"some-string\".to_string()),\n                    assign_tags: Some(vec![Some(4 as i64)]),\n                    assign_correspondent: Some(4 as i64),\n                    assign_document_type: Some(4 as i64),\n                    assign_storage_path: Some(4 as i64),\n                    assign_owner: Some(4 as i64),\n                    assign_view_users: Some(vec![4 as i64]),\n                    assign_view_groups: Some(vec![4 as i64]),\n                    assign_change_users: Some(vec![4 as i64]),\n                    assign_change_groups: Some(vec![4 as i64]),\n                    assign_custom_fields: Some(vec![4 as i64]),\n                    assign_custom_fields_values: Some(serde_json::Value::String(\n                        \"some-string\".to_string(),\n                    )),\n                    remove_all_tags: Some(true),\n                    remove_tags: Some(vec![4 as i64]),\n                    remove_all_correspondents: Some(true),\n                    remove_correspondents: Some(vec![4 as i64]),\n                    remove_all_document_types: Some(true),\n                    remove_document_types: Some(vec![4 as i64]),\n                    remove_all_storage_paths: Some(true),\n                    remove_storage_paths: Some(vec![4 as i64]),\n                    remove_custom_fields: Some(vec![4 as i64]),\n                    remove_all_custom_fields: Some(true),\n                    remove_all_owners: Some(true),\n                    remove_owners: Some(vec![4 as i64]),\n                    remove_all_permissions: Some(true),\n                    remove_view_users: Some(vec![4 as i64]),\n                    remove_view_groups: Some(vec![4 as i64]),\n                    remove_change_users: Some(vec![4 as i64]),\n                    remove_change_groups: Some(vec![4 as i64]),\n                    email: Some(paperless_api_client::types::WorkflowActionEmailRequest {\n                        id: Some(4 as i64),\n                        subject: \"some-string\".to_string(),\n                        body: \"some-string\".to_string(),\n                        to: \"some-string\".to_string(),\n                        include_document: Some(true),\n                    }),\n                    webhook: Some(paperless_api_client::types::WorkflowActionWebhookRequest {\n                        id: Some(4 as i64),\n                        url: \"some-string\".to_string(),\n                        use_params: Some(true),\n                        as_json: Some(true),\n                        params: Some(serde_json::Value::String(\"some-string\".to_string())),\n                        body: Some(\"some-string\".to_string()),\n                        headers: Some(serde_json::Value::String(\"some-string\".to_string())),\n                        include_document: Some(true),\n                    }),\n                }],\n            },\n        )\n        .await?;\n    println!(\"{:?}\", result);\n    Ok(())\n}\n```"]
    #[tracing::instrument]
    #[allow(non_snake_case)]
    ...
    #[doc = "Perform a `DELETE` request to `/api/workflows/{id}/`.\n\n**Parameters:**\n\n- `id: i64`: A unique integer value identifying this workflow. (required)\n\n```rust,no_run\nasync fn example_workflows_destroy() -> anyhow::Result<()> {\n    let client = paperless_api_client::Client::new_from_env();\n    client.workflows().destroy(4 as i64).await?;\n    Ok(())\n}\n```"]
    #[tracing::instrument]
    #[allow(non_snake_case)]
    ...
    #[doc = "Perform a `PATCH` request to `/api/workflows/{id}/`.\n\n**Parameters:**\n\n- `id: i64`: A unique integer value identifying this workflow. (required)\n\n```rust,no_run\nasync fn example_workflows_partial_update() -> anyhow::Result<()> {\n    let client = paperless_api_client::Client::new_from_env();\n    let result: paperless_api_client::types::Workflow = client\n        .workflows()\n        .partial_update(\n            4 as i64,\n            &paperless_api_client::types::PatchedWorkflowRequest {\n                name: Some(\"some-string\".to_string()),\n                order: Some(4 as i64),\n                enabled: Some(true),\n                triggers: Some(vec![paperless_api_client::types::WorkflowTriggerRequest {\n                    id: Some(4 as i64),\n                    sources: vec![paperless_api_client::types::SourcesEnum::MailFetch],\n                    type_: paperless_api_client::types::WorkflowTriggerTypeEnum::DocumentUpdated,\n                    filter_path: Some(\"some-string\".to_string()),\n                    filter_filename: Some(\"some-string\".to_string()),\n                    filter_mailrule: Some(4 as i64),\n                    matching_algorithm: Some(\n                        paperless_api_client::types::WorkflowTriggerMatchingAlgorithmEnum::ExactMatch,\n                    ),\n                    match_: Some(\"some-string\".to_string()),\n                    is_insensitive: Some(true),\n                    filter_has_tags: Some(vec![4 as i64]),\n                    filter_has_all_tags: Some(vec![4 as i64]),\n                    filter_has_not_tags: Some(vec![4 as i64]),\n                    filter_custom_field_query: Some(\"some-string\".to_string()),\n                    filter_has_not_correspondents: Some(vec![4 as i64]),\n                    filter_has_not_document_types: Some(vec![4 as i64]),\n                    filter_has_not_storage_paths: Some(vec![4 as i64]),\n                    filter_has_correspondent: Some(4 as i64),\n                    filter_has_document_type: Some(4 as i64),\n                    filter_has_storage_path: Some(4 as i64),\n                    schedule_offset_days: Some(4 as i64),\n                    schedule_is_recurring: Some(true),\n                    schedule_recurring_interval_days: Some(4 as i64),\n                    schedule_date_field: Some(paperless_api_client::types::ScheduleDateFieldEnum::Modified),\n                    schedule_date_custom_field: Some(4 as i64),\n                }]),\n                actions: Some(vec![paperless_api_client::types::WorkflowActionRequest {\n                    id: Some(4 as i64),\n                    type_: Some(paperless_api_client::types::WorkflowActionTypeEnum::Email),\n                    assign_title: Some(\"some-string\".to_string()),\n                    assign_tags: Some(vec![Some(4 as i64)]),\n                    assign_correspondent: Some(4 as i64),\n                    assign_document_type: Some(4 as i64),\n                    assign_storage_path: Some(4 as i64),\n                    assign_owner: Some(4 as i64),\n                    assign_view_users: Some(vec![4 as i64]),\n                    assign_view_groups: Some(vec![4 as i64]),\n                    assign_change_users: Some(vec![4 as i64]),\n                    assign_change_groups: Some(vec![4 as i64]),\n                    assign_custom_fields: Some(vec![4 as i64]),\n                    assign_custom_fields_values: Some(serde_json::Value::String(\n                        \"some-string\".to_string(),\n                    )),\n                    remove_all_tags: Some(true),\n                    remove_tags: Some(vec![4 as i64]),\n                    remove_all_correspondents: Some(true),\n                    remove_correspondents: Some(vec![4 as i64]),\n                    remove_all_document_types: Some(true),\n                    remove_document_types: Some(vec![4 as i64]),\n                    remove_all_storage_paths: Some(true),\n                    remove_storage_paths: Some(vec![4 as i64]),\n                    remove_custom_fields: Some(vec![4 as i64]),\n                    remove_all_custom_fields: Some(true),\n                    remove_all_owners: Some(true),\n                    remove_owners: Some(vec![4 as i64]),\n                    remove_all_permissions: Some(true),\n                    remove_view_users: Some(vec![4 as i64]),\n                    remove_view_groups: Some(vec![4 as i64]),\n                    remove_change_users: Some(vec![4 as i64]),\n                    remove_change_groups: Some(vec![4 as i64]),\n                    email: Some(paperless_api_client::types::WorkflowActionEmailRequest {\n                        id: Some(4 as i64),\n                        subject: \"some-string\".to_string(),\n                        body: \"some-string\".to_string(),\n                        to: \"some-string\".to_string(),\n                        include_document: Some(true),\n                    }),\n                    webhook: Some(paperless_api_client::types::WorkflowActionWebhookRequest {\n                        id: Some(4 as i64),\n                        url: \"some-string\".to_string(),\n                        use_params: Some(true),\n                        as_json: Some(true),\n                        params: Some(serde_json::Value::String(\"some-string\".to_string())),\n                        body: Some(\"some-string\".to_string()),\n                        headers: Some(serde_json::Value::String(\"some-string\".to_string())),\n                        include_document: Some(true),\n                    }),\n                }]),\n            },\n        )\n        .await?;\n    println!(\"{:?}\", result);\n    Ok(())\n}\n```"]
    #[tracing::instrument]
    #[allow(non_snake_case)]
    pub async fn partial_update<'a>(
        &'a self,
        id: i64,
        body: &crate::types::PatchedWorkflowRequest,
    ) -> Result<crate::types::Workflow, crate::types::error::Error> {
        let mut req = self.client.client.request(
            http::Method::PATCH,
            format!(
